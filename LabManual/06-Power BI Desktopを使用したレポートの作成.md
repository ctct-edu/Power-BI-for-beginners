...
1. デフォルトの設定ではバブルのサイズが小さいため、サイズを調整します。ビジュアルが選択されている状態で、 **視覚化ペイン** の **ビジュアルの書式設定** から **バブルレイヤー** を展開し、 **サイズ** の最小値を **10** 、最大値を **350** に変更します。

1. 同じく書式設定のバブルレイヤーの項目にて **色** を展開し、 **fx** のボタンをクリックします。

1. **カラー - バブル レイヤー - 色** のウィンドウで以下の項目を設定します。設定が完了したら **OK** をクリックして適用します。
